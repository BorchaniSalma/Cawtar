...
var updateRegisterTermsOfServiceText = function () {
  $("body #register .plaintext-field a")
    .first()
    .text(function () {
      return $(this)
        .text()
        .replace("Terms of Service and Honor Code", "Terms of Service");
    });
};

var updatePublicUsernameFieldTitle = function () {
  $("body #register .required-fields .text-username label span.label-text")
    .first()
    .text("Username");
};
